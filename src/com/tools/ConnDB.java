...
public class ConnDB {
	...
	private static String dbUser = "shinelon"; // 登录SQL Server的用户名
	private static String dbPwd = "960206ash"; // 登录SQL Server的密码
	...
	public int executeUpdate(String sql) {
		...
		try {// 捕捉异常
			...
			stmt = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);// 结果集的游标可以上下移动，当数据库变化时，当前结果集不变；不能用结果集更新数据库中的表。
